...
public class PoolCreatorInspector : Editor
{
    ...
    private const string poolsPrefabsFolder = "Pools";
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("Choose Folder For Pool's Prefab"))
        {
            ...
            prefabPath = TrimFilePathBeforeSeparator(prefabPath, assetsString);
        ...
        if (GUILayout.Button("Create Pool From This Object"))
        {
            ...
            {
                Directory.CreateDirectory($"Assets/{prefabPath}");
                //AssetDatabase.CreateFolder("Assets", prefabFolder);
                AssetDatabase.CreateFolder($"{prefabFolder}", poolsPrefabsFolder);
                //AssetDatabase.CreateFolder($"Assets/{prefabFolder}", poolsPrefabsFolder);
            }
             
        

           // prefabPath = AssetDatabase.GenerateUniqueAssetPath(prefabPath);
            string prefabFilePath = $"Assets/{prefabPath}/{targetClassName + "Pool"}.prefab";
